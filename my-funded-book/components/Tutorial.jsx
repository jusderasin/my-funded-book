...
const SLIDES = [
  ...
  { icon: LayoutGrid, accent: "#00d301",
    ...
    body: { fr: "Ta vue d'ensemble : P&L net, win rate, profit factor, Edge Score et tes courbes. Et en haut, ta bannière de risque : combien il te reste avant ta daily loss et ton drawdown.", en: "Your overview: net P&L, win rate, profit factor, Edge Score and your curves. And on top, your risk banner: how much room before your daily loss and drawdown." } },
  { icon: Table2, accent: "#7fd0ff",
    title: { fr: "Comptes", en: "Accounts" },
    body: { fr: "Gère tes comptes prop firm (évals et financés) : statut, taille, coûts, et tes règles de risque (daily loss, drawdown, trailing). C'est ce qui alimente l'alerte live du tableau de bord.", en: "Manage your prop firm accounts (evals and funded): status, size, costs, and your risk rules (daily loss, drawdown, trailing). This feeds the live alert on your dashboard." } },
  { icon: ListChecks, accent: "#00d301",
    title: { fr: "Journal", en: "Journal" },
    body: { fr: "Le cœur de l'app. Logge chaque trade (sens, grade, R, PnL, sortie TP/SL/BE, tags) et surtout le WHY, avec une capture. C'est ici que ton edge se construit.", en: "The heart of the app. Log every trade (direction, grade, R, PnL, TP/SL/BE exit, tags) and above all the WHY, with a screenshot. This is where your edge is built." } },
  ...
  { icon: Trophy, accent: "#f5b301",
    title: { fr: "Classement", en: "Leaderboard" },
    body: { fr: "Compare-toi aux autres traders sur le R cumulé. Participe (opt-in dans les Réglages) et ton profil public affiche tes stats et badges. Seuls les trades avec capture comptent.", en: "Compare yourself to other traders on cumulative R. Opt in (in Settings) and your public profile shows your stats and badges. Only screenshotted trades count." } },
  { icon: CalendarDays, accent: "#7fd0ff",
    title: { fr: "Calendrier", en: "Calendar" },
    body: { fr: "Visualise tes trades jour par jour. Repère tes séries, tes jours verts et rouges d'un coup d'œil.", en: "See your trades day by day. Spot your streaks, your green and red days at a glance." } },
  ...
  { icon: Sparkles, accent: "#00d301",
    title: { fr: "Rapport IA", en: "AI Report" },
    body: { fr: "Génère un bilan d'analyse par IA sur une période : points forts, fuites, discipline et recos concrètes. Basé sur tes trades loggés.", en: "Generate an AI analysis report over a period: strengths, leaks, discipline and concrete tips. Based on your logged trades." } },
