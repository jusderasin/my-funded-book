  ...
  theme: {
    extend: {
      colors: {
        ...
        prism: {
          bg:         "var(--prism-bg, #000000)",
          surface:    "var(--prism-surface, #050505)",
          panel:      "var(--prism-panel, #0a0a0a)",
          panel2:     "var(--prism-panel2, #141414)",
          line:       "var(--prism-line, rgba(255, 255, 255, 0.08))",
          line2:      "var(--prism-line2, rgba(255, 255, 255, 0.12))",
          text:       "var(--prism-text, #ffffff)",
          muted:      "var(--prism-muted, #a1a1aa)",
          muted2:     "var(--prism-muted2, #71717a)",
          accent:     "var(--prism-accent, #3b82f6)",
          accentSoft: "var(--prism-accent-soft, #60a5fa)",
          accentDim:  "var(--prism-accent-dim, rgba(59, 130, 246, 0.12))",
          win:        "var(--prism-win, #22c55e)",
          loss:       "var(--prism-loss, #ef4444)",
        },
      },
      fontFamily: {
